...
mkdir /etc/rspamd/plugins.d /etc/rspamd/custom

touch /etc/rspamd/rspamd.conf.local /etc/rspamd/rspamd.conf.override
...
chown wwwrun:www /etc/rspamd/custom/*
chmod 644 /etc/rspamd/custom/*
